...
import static org.musicbrainz.search.analysis.MusicbrainzWordDelimiterGraphFilter.*;
import static org.musicbrainz.search.analysis.MusicbrainzWordDelimiterIterator.*;

/**
 * Factory for {@link MusicbrainzWordDelimiterGraphFilter}.
 ...
 * @since 6.5.0
 */
public class MusicbrainzWordDelimiterGraphFilterFactory extends TokenFilterFactory implements ResourceLoaderAware {
    ...
    public MusicbrainzWordDelimiterGraphFilterFactory(Map<String, String> args) {
        super(args);
        int flags = 0;
    ...
    public TokenFilter create(TokenStream input) {
        return new MusicbrainzWordDelimiterGraphFilter(input, typeTable == null ? MusicbrainzWordDelimiterIterator.DEFAULT_WORD_DELIM_TABLE : typeTable,
    ...
    private byte[] parseTypes(List<String> rules) {
        ...
        byte types[] = new byte[Math.max(typeMap.lastKey()+1, MusicbrainzWordDelimiterIterator.DEFAULT_WORD_DELIM_TABLE.length)];
        for (int i = 0; i < types.length; i++)
            types[i] = MusicbrainzWordDelimiterIterator.getType(i);
