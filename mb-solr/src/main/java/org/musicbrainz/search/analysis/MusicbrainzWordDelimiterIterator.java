...
/**
 * A BreakIterator-like API for iterating over subwords in text, according to MusicbrainzWordDelimiterGraphFilter rules.
 * @lucene.internal
 */
public final class MusicbrainzWordDelimiterIterator {
    ...
    /**
     * Create a new MusicbrainzWordDelimiterIterator operating with the supplied rules.
     *
     ...
     */
    MusicbrainzWordDelimiterIterator(byte[] charTypeTable, boolean splitOnCaseChange, boolean splitOnNumerics, boolean stemEnglishPossessive) {
